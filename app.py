...
def capture_and_select_best_image(camera_port, num_frames=5):
...
while True:
    # Process IN camera
    img_in = capture_and_select_best_image(in_camera_port)
    ...
    # Process OUT camera
    img_out = capture_and_select_best_image(out_camera_port)
